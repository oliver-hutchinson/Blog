...
def login():
    ...
    if form.validate_on_submit():
        ...
        if not user_to_login:
            ...
            return redirect(url_for('login'))
        password_allowed = check_password_hash(user_to_login.password, request.form['password'])
...
def contact():
    if request.method == "POST":
        ...
        return render_template("contact.html", logged_in=current_user.is_authenticated, success=True)
    return render_template("contact.html", logged_in=current_user.is_authenticated, success=False)
